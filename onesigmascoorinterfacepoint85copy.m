...
% m2=44;
for ii=1:1:9
    filename=strcat('D:\Newdataanalysis\1boxes\W3\AA_',num2str(ii),'_point95.mat');
    load(filename);
    m1=47;
    m2=31;
...
clear N2 N R timet
filename=strcat('D:\Final Data\1ta-data analysis\W3\W3-final-0.67-0.15-box-',num2str(m1),'-',num2str(m2),'point95.mat');
save(filename,'-v7.3');