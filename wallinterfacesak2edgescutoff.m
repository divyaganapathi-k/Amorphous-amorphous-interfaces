...
% Amplitude2(:,1)=(2*pi)/(138*(0.5)*(sigmas)):(2*pi)/(138*(0.5)*(sigmas)):2*pi/((0.1)*(0.5)*(sigmas));
% for i=1:1:9
...
% f=find(coordinates1(:,1)>=4 & coordinates1(:,1)<=141);
% coordinates1=coordinates1(f,1:3);
% coordinates1(:,1)=coordinates1(:,1)-3;
% n=max(coordinates1(:,3));
% f=find(coordinates2(:,2));
% coordinates2=coordinates2(f,1:3);
% f=find(coordinates2(:,1)>=4 & coordinates2(:,1)<=141);
% coordinates2=coordinates2(f,1:3);
% coordinates2(:,1)=coordinates2(:,1)-3;
% f=find(coordinates3(:,2));
% coordinates3=coordinates3(f,1:3);
% f=find(coordinates3(:,1)>=4 & coordinates3(:,1)<=141);
% coordinates3=coordinates3(f,1:3);
% coordinates3(:,1)=coordinates3(:,1)-3;
% f=find(coordinates4(:,2));
% coordinates4=coordinates4(f,1:3);
% f=find(coordinates4(:,1)>=4 & coordinates4(:,1)<=141);
% coordinates4=coordinates4(f,1:3);
% coordinates4(:,1)=coordinates4(:,1)-3;
% f=find(coordinates5(:,2));
% coordinates5=coordinates5(f,1:3);
% f=find(coordinates5(:,1)>=4 & coordinates5(:,1)<=141);
% coordinates5=coordinates5(f,1:3);
% coordinates5(:,1)=coordinates5(:,1)-3;
% f=find(coordinates6(:,2));
% coordinates6=coordinates6(f,1:3);
% f=find(coordinates6(:,1)>=4 & coordinates6(:,1)<=141);
% coordinates6=coordinates6(f,1:3);
% coordinates6(:,1)=coordinates6(:,1)-3;
% f=find(coordinates7(:,2));
% coordinates7=coordinates7(f,1:3);
% f=find(coordinates7(:,1)>=4 & coordinates7(:,1)<=141);
% coordinates7=coordinates7(f,1:3);
% coordinates7(:,1)=coordinates7(:,1)-3;
% f=find(coordinates8(:,2));
% coordinates8=coordinates8(f,1:3);
% f=find(coordinates8(:,1)>=4 & coordinates8(:,1)<=141);
% coordinates8=coordinates8(f,1:3);
% coordinates8(:,1)=coordinates8(:,1)-3;
% f=find(coordinates9(:,2));
% coordinates9=coordinates9(f,1:3);
% f=find(coordinates9(:,1)>=4 & coordinates9(:,1)<=141);
% coordinates9=coordinates9(f,1:3);
% coordinates9(:,1)=coordinates9(:,1)-3;
% yaverage1=[];
...
% filename='D:\Newdataanalysis\Ak2-wall\W7-1.mat';
% save(filename);
...
% Amplitude2(:,2)=Amplitude2(:,2)/n;
filename='D:\Newdataanalysis\Ak2-wall\W2-1.mat';
save(filename);
