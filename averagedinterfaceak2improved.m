...
% m2=17;
% for l=1:1:9
%     filename=strcat('D:\Newdataanalysis\ak2\W7\W7-shiftedinterface1',num2str(l),'-',num2str(m1),'-',num2str(m2),'.mat');    
%     load(filename);
%     v=genvarname(strcat('coorinterface',num2str(l)));
%     eval([v '=coorinterface;']);
% end
...
%     j=j+1;
% end
% filename=strcat('D:\Newdataanalysis\ak2\W7\W7-final-1ta-',num2str(m1),'-',num2str(m2),'.mat');
% save(filename);
% 
% clearvars
% m1=48;
