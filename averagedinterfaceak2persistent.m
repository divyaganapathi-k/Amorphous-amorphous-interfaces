...
%     filename=strcat('D:\Newdataanalysis\W3\W3-finalshiftedinterface1',num2str(ii),'.mat');
%     filename=strcat('D:\Final Data\1ta-data analysis\W3\W3final-shiftedinterfaceta1',num2str(ii),'.mat');
%     filename=strcat('D:\Final Data\W3\W3final-shiftedinterface7',num2str(ii),'.mat');
%     filename=strcat('D:\Newdataanalysis\1boxes\W3\AA_persistent_',num2str(ii),'_point8.mat');
    load(filename);
    m1=53;
    m2=13;
...
% filename=(strcat('D:\Final Data\1ta-data analysis\W3\W3-final-0.67-0.15-box-',num2str(m1),'-',num2str(m2),'forimage.mat'));
load(filename);
FinalCoordinates=[];
% for j1=1:1:9
% %     filename=strcat('D:\Newdataanalysis\1boxes\W3\W3-shiftedinterface1sigmas1',num2str(j1),'-58-24.mat');
%     filename=strcat('E:\1boxes\W3\W3-shiftedinterface1sigmas1',num2str(j1),'-58-17.mat');
%     load(filename);
...
% filename=(strcat('D:\Newdataanalysis\mosaic\W3\W3-',num2str(m1),'-',num2str(m2),'.mat'));
...
fluctuations2=fluctuations-smooth(fluctuations,100);
...
% end
filename=strcat('D:\Final Data\1ta-data analysis\W3\persistencefunction\W3-final-ak2-0.67-0.15-box-',num2str(m1),'-',num2str(m2),'.mat');
save(filename,'-v7.3');