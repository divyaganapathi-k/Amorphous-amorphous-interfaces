...
R=dlmread('C:\Users\Divya\Desktop\codes\W7_0T_1-8000_trk(18,0,10)_DD(100).txt','\t');
for iii=1:1:1
for ii=1:1:9
...
%         E2(:,5)=i;
    ...
    filename=strcat('C:\Users\Divya\Desktop\codes\Data-Analysed\W7final-shiftedinterfaceta',num2str(iii),num2str(ii),'.mat');
    save(filename);
end
end
clear all
R=dlmread('C:\Users\Divya\Desktop\codes\W8_0T_1-14000_trk(18,0,10)_DD(100).txt','\t');
for iii=1:1:1
for ii=1:1:9
    clearvars -except R ii iii
    n=max(R(:,3));
...
%         B=N2(:,:,i);
        ...
        %third quadrant
        f=find(C(:,1)==b31 & C(:,2)>=(b32+1) & C(:,2)<=h2, 1);
        if isempty(f)==0
            breakvalue=b31;
        else
            f=find(C(:,1)==(b31-1) & C(:,2)>=(b32+1) & C(:,2)<=h2);
...
%         E2(:,5)=i;
    ...
    filename=strcat('C:\Users\Divya\Desktop\codes\Data-Analysed\W8final-shiftedinterfaceta',num2str(iii),num2str(ii),'.mat');
    save(filename);
end
end
clear all
R=dlmread('C:\Users\Divya\Desktop\codes\W3_1-10000_trk(18,0,10)_DD(100).txt','\t');
for iii=1:1:1
for ii=1:1:9
    clearvars -except R ii iii
    n=max(R(:,3));
...
%         E2(:,5)=i;
    ...
    filename=strcat('C:\Users\Divya\Desktop\codes\Data-Analysed\W3final-shiftedinterfaceta',num2str(iii),num2str(ii),'.mat');
    save(filename);
end
end