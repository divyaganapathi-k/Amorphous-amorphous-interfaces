...
clearvars
for ii=1:1:9
    filename=strcat('D:\Newdataanalysis\1boxes\W4\AA_',num2str(ii),'_point95.mat');
    load(filename);
    m1=47;
    m2=31;
...
m1=47;
m2=31;
filename=(strcat('D:\Final Data\1ta-data analysis\W4\W4-final-0.67-0.15-box-',num2str(m1),'-',num2str(m2),'point95.mat'));
% filename=(strcat('D:\Final Data\1ta-data analysis\W4\W4-final-0.67-0.15-box-',num2str(m1),'-',num2str(m2),'forimage.mat'));
load(filename);
FinalCoordinates=[];
% for j1=1:1:9
% %     filename=strcat('D:\Newdataanalysis\1boxes\W4\W4-shiftedinterface1sigmas1',num2str(j1),'-58-24.mat');
%     filename=strcat('E:\1boxes\W4\W4-shiftedinterface1sigmas1',num2str(j1),'-58-17.mat');
%     load(filename);
...
% filename=(strcat('D:\Newdataanalysis\mosaic\W4\W4-',num2str(m1),'-',num2str(m2),'.mat'));
...
% end
filename=strcat('D:\Final Data\1ta-data analysis\W4\W4-final-ak2-0.67-0.15-box-',num2str(m1),'-',num2str(m2),'point95.mat');
save(filename,'-v7.3');