...
%     end
%     for dummy=1:1:9
%         filename=strcat('D:\Newdataanalysis\1boxes\W2\AA_',num2str(dummy),'_point85','.mat');
% %         filename=strcat('D:\Newdataanalysis\1boxes\W2\W2unpinned-shiftedinterfacetasigmas1',num2str(dummy),'.mat');
%         load(filename);
