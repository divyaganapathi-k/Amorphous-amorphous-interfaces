...
%     load(strcat('D:\Final Data\1ta-data analysis\W2\W2final-shiftedinterfaceta1',num2str(ii),'.mat'));
...
clear N2 N R timet
filename=strcat('D:\Final Data\1ta-data analysis\W2\W2-final-0.67-0.15-box-',num2str(m1),'-',num2str(m2),'sameregion.mat');
save(filename,'-v7.3');