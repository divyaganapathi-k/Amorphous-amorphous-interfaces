clearvars
for j1=1:1:9
%     filename=strcat('D:\Newdataanalysis\1boxes\W8\W8unpinned-shiftedinterfacehalftasigmas1',num2str(j1),'.mat');
    filename=strcat('D:\Newdataanalysis\1boxes\W8\W8unpinned-persistancesigmas1',num2str(j1),'.mat');
%     filename=strcat('D:\Final Data\W8\W8final-shiftedinterface7',num2str(j1),'.mat');
    load(filename);
    F=find(Np>=0.9);
    AA=[]; 
