...
for iii=1:1:1
for ii=1:1:9
%     filename=strcat('D:\Final Data\1ta-data analysis\W8\W8final-shiftedinterfaceta1',num2str(ii),'.mat');
...
%     boxsiz=1;
    ...
    if ii==1
     ...
     addon2=((0)*sigmas);
    elseif ii==2
        addon1=((valueshift)*sigmas);
        addon2=((0)*sigmas);
    elseif ii==3
        addon1=((0)*sigmas);
        addon2=((valueshift)*sigmas);
    elseif ii==4
        addon1=((-valueshift)*sigmas);
        addon2=((0)*sigmas);
    elseif ii==5
    ...
    if ii==6
       addon1=(((valueshift)*sigmas)*cos(pi/4));
       addon2=(((valueshift)*sigmas)*sin(pi/4));
    elseif ii==7
         addon1=-(((valueshift)*sigmas)*cos(pi/4));
         addon2=(((valueshift)*sigmas)*sin(pi/4));
    elseif ii==8
...
%         E2(:,5)=i;
    ...
    filename=strcat('D:\Final Data\1ta-data analysis\W2\W2-final-0.4-0.084-box-',num2str(iii),num2str(ii),'.mat');
%      filename=strcat('D:\Newdataanalysis\1boxes\W8\W8unpinned-shiftedinterfacetasigmas',num2str(iii),num2str(ii),'.mat');
     save(filename,'-v7.3');
end
end
% clear N2 N R
% filename=strcat('D:\Final Data\1ta-data analysis\W2\W2-final-0.4-0.084-box-',num2str(m1),'-',num2str(m2),'-3-test.mat');
% save(filename,'-v7.3');
