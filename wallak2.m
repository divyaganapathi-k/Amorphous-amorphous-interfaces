clearvars
for ii=1:1:9
    load(strcat('E:\Wall-Data Analysis\W4\FinalCoordinates_shiftedinterface',num2str(ii),'.mat'));
...
x=(3*((21.7)/20.66)):((2*2.17)/20.66):(42*((21.7)/20.66));
...
Amplitude2(:,2)=Amplitude2(:,2)/2800;