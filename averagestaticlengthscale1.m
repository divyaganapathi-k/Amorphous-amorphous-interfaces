% clearvars
% % load('F:\dynamiclengthscale\W8\W8lengthoft.mat');
% R=load('D:\Raw Data\W8_0T_1-14000_trk(18,0,10)_DD(100).txt');
m1=60;
m2=30;
for zz=1:1:1
%     filename=strcat('D:\Final Data\1ta-data analysis\W8\W8-',num2str(zz),'.mat');
%     load(filename);
...
%         filename=strcat('D:\Newdataanalysis\avstaticlengthscale\W8\W8staticlen',num2str(iii),'-',num2str(m1),'-',num2str(m2),'-1','.mat');
%         save(filename,'overlapfunction');
        filename=strcat('D:\Newdataanalysis\W5staticlen',num2str(iii),'-',num2str(m1),'-',num2str(m2),'.mat');
        save(filename,'overlapfunction');
    end
end