...
%     averaging to get the percentage occupancy
    ...
    filename=strcat('D:\Newdataanalysis\point2boxes\W8point2boxes-shiftedinterface',num2str(iii),num2str(ii),'.mat');
    save(filename);
end
end
...
%     averaging to get the percentage occupancy
    ...
    filename=strcat('D:\Newdataanalysis\point2boxes\W5point2boxes-shiftedinterface',num2str(iii),num2str(ii),'.mat');
    save(filename);
end
end