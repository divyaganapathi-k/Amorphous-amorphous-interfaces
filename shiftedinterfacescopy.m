...
% to be of 0.1sigmas to make it statistically countable
% close all
...
%         B=N2(:,:,i);
        ...
        E=[];
        E(:,1)=D(:,1)*(boxsiz)*(sigmas)-((boxsiz/2));
        E(:,2)=D(:,2)*(boxsiz)*(sigmas)-((boxsiz/2));
        E(:,3)=D(:,3);
...
%     filename=strcat('D:\Final Data\1ta-data analysis\W3-shiftedinterface',num2str(iii),num2str(ii),'.mat');
%      filename=strcat('D:\Newdataanalysis\1boxes\W8\W8unpinned-shiftedinterfacetasigmas',num2str(iii),num2str(ii),'.mat');
%      save(filename,'-v7.3');
end
end
% 
clear N2 N R timet
filename=strcat('D:\Final Data\1ta-data analysis\W2\W2-final-0.4-0.084-box-',num2str(m1),'-',num2str(m2),'-2.mat');
save(filename,'-v7.3');
