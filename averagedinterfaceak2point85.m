...
clearvars
for ii=1:1:9
    filename=strcat('D:\Newdataanalysis\1boxes\W8\AA_',num2str(ii),'_point95.mat');
    load(filename);
    m1=33;
    m2=16;
...
m1=33;
m2=16;
filename=(strcat('D:\Final Data\1ta-data analysis\W8\W8-final-0.67-0.15-box-',num2str(m1),'-',num2str(m2),'point95.mat'));
% filename=(strcat('D:\Final Data\1ta-data analysis\W8\W8-final-0.67-0.15-box-',num2str(m1),'-',num2str(m2),'forimage.mat'));
load(filename);
FinalCoordinates=[];
% for j1=1:1:9
% %     filename=strcat('D:\Newdataanalysis\1boxes\W8\W8-shiftedinterface1sigmas1',num2str(j1),'-58-24.mat');
%     filename=strcat('E:\1boxes\W8\W8-shiftedinterface1sigmas1',num2str(j1),'-58-17.mat');
%     load(filename);
...
% filename=(strcat('D:\Newdataanalysis\mosaic\W8\W8-',num2str(m1),'-',num2str(m2),'.mat'));
...
% end
filename=strcat('D:\Final Data\1ta-data analysis\W8\W8-final-ak2-0.67-0.15-box-',num2str(m1),'-',num2str(m2),'point95.mat');
save(filename,'-v7.3');