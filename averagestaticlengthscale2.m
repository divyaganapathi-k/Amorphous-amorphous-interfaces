clearvars
% R=load('DD:\Raw Data\W8_0T_1-14000_trk(18,0,10)_DD(100).txt');
for zz=1:1:7
    ...
    z2=m2;
    for dummy=1:1:9
        filename=strcat('D:\Final Data\1ta-data analysis\W8\W8final-shiftedinterfaceta1',num2str(dummy),'.mat');
        load(filename);
