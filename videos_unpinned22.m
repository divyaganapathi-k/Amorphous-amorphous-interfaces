...
%    set(gca,'TickDir','out');
%    h=gcf;
%    saveas(h,strcat('E:\Final version-Movies(interfaces)\W2-unpinned-persistent\',num2str(j),'.tif'));
%    j=j+1;
% end
...
for i=1:30:3030
    ...
    if isempty(f)==0
        ...
        plot(((FinalCoordinates1(f,4)-0.5)*(473/44)),((FinalCoordinates1(f,5)-0.5)*(765/71)),'Color',[0.4 0.4 0.4],'LineWidth',2);
        finalcoordinates(1,1:2)=FinalCoordinates1(f(1),4:5);
        finalcoordinates(2,1:2)=FinalCoordinates1(f(end),4:5);
        plot(((finalcoordinates(:,1)-0.5)*(473/44)),((finalcoordinates(:,2)-0.5)*(765/71)),'Color',[0.4 0.4 0.4],'LineWidth',2);
    end
    ...
    if isempty(f)==0
        ...
        plot(((FinalCoordinates2(f,4)-0.5)*(473/44)),((FinalCoordinates2(f,5)-0.5)*(765/71)),'Color',[0.7 0.7 0.7],'LineWidth',2);
        finalcoordinates(1,1:2)=FinalCoordinates2(f(1),4:5);
        finalcoordinates(2,1:2)=FinalCoordinates2(f(end),4:5);
        plot(((finalcoordinates(:,1)-0.5)*(473/44)),((finalcoordinates(:,2)-0.5)*(765/71)),'Color',[0.7 0.7 0.7],'LineWidth',2);
    end
    f=find(FinalCoordinates3(:,3)==i);
    if isempty(f)==0
        scatter((14*(473/44)),(43*(765/71)),10,'MarkerEdgeColor',[1 1 1],'MarkerFaceColor',[1 0 0],'LineWidth',1);
        plot((FinalCoordinates3(f,4)*(473/44)),(FinalCoordinates3(f,5)*(765/71)),'Color',[1 0.58 0.6],'LineWidth',2);
        finalcoordinates(1,1:2)=FinalCoordinates3(f(1),4:5);
        finalcoordinates(2,1:2)=FinalCoordinates3(f(end),4:5);
        plot((finalcoordinates(:,1)*(473/44)),(finalcoordinates(:,2)*(765/71)),'Color',[1 0.58 0.6],'LineWidth',2);
    end
...
%     end
    ...
    if isempty(f)==0
        ...
        plot(((FinalCoordinates5(f,4)-0.5)*(473/44)),((FinalCoordinates5(f,5)-0.5)*(765/71)),'Color',[0.2 0.3 0.9],'LineWidth',2);
        finalcoordinates(1,1:2)=FinalCoordinates5(f(1),4:5);
        finalcoordinates(2,1:2)=FinalCoordinates5(f(end),4:5);
        plot(((finalcoordinates(:,1)-0.5)*(473/44)),((finalcoordinates(:,2)-0.5)*(765/71)),'Color',[0.2 0.3 0.9],'LineWidth',2);
    end
    ...
    if isempty(f)==0
        ...
        plot(((FinalCoordinates6(f,4)-0.5)*(473/44)),((FinalCoordinates6(f,5)-0.5)*(765/71)),'Color',[0.9 0.9 0.9],'LineWidth',2);
        finalcoordinates(1,1:2)=FinalCoordinates6(f(1),4:5);
        finalcoordinates(2,1:2)=FinalCoordinates6(f(end),4:5);
        plot(((finalcoordinates(:,1)-0.5)*(473/44)),((finalcoordinates(:,2)-0.5)*(765/71)),'Color',[0.9 0.9 0.9],'LineWidth',2);
    end
    f=find(FinalCoordinates7(:,3)==i);
    if isempty(f)==0
        scatter((10*(473/44)),(57*(765/71)),10,'MarkerEdgeColor',[1 1 1],'MarkerFaceColor',[1 0 0],'LineWidth',1);
        plot((FinalCoordinates7(f,4)*(473/44)),(FinalCoordinates7(f,5)*(765/71)),'Color',[0.8 0.05 0.05],'LineWidth',2);
        finalcoordinates(1,1:2)=FinalCoordinates7(f(1),4:5);
        finalcoordinates(2,1:2)=FinalCoordinates7(f(end),4:5);
        plot((finalcoordinates(:,1)*(473/44)),(finalcoordinates(:,2)*(765/71)),'Color',[0.8 0.05 0.05],'LineWidth',2);
    end
    f=find(FinalCoordinates8(:,3)==i);
    if isempty(f)==0
        scatter((30*(473/44)),(63*(765/71)),10,'MarkerEdgeColor',[1 1 1],'MarkerFaceColor',[1 0 0],'LineWidth',1);
        plot((FinalCoordinates8(f,4)*(473/44)),(FinalCoordinates8(f,5)*(473/44)),'Color',[0.7 0.7 1],'LineWidth',2);
        finalcoordinates(1,1:2)=FinalCoordinates8(f(1),4:5);
        finalcoordinates(2,1:2)=FinalCoordinates8(f(end),4:5);
        plot((finalcoordinates(:,1)*(473/44)),(finalcoordinates(:,2)*(473/44)),'Color',[0.7 0.7 1],'LineWidth',2);
    end
...
%     end
    ...
    if isempty(f)==0
        ...
        plot((FinalCoordinates10(f,4)*(765/71)),(FinalCoordinates10(f,5)*(473/44)),'Color',[0.8 0.5 0.5],'LineWidth',2);
        finalcoordinates(1,1:2)=FinalCoordinates10(f(1),4:5);
        finalcoordinates(2,1:2)=FinalCoordinates10(f(end),4:5);
        plot(((finalcoordinates(:,1)-0.5)*(473/44)),((finalcoordinates(:,2)-0.5)*(765/71)),'Color',[0.8 0.5 0.5],'LineWidth',2);
    end
    ...
    if isempty(f)==0
        ...
        plot(((FinalCoordinates11(f,4)-0.5)*(473/44)),((FinalCoordinates11(f,5)-0.5)*(765/71)),'Color',[0.3 0.5 0.8],'LineWidth',2);
...
%     end
    ...
    if isempty(f)==0
        ...
        plot(((FinalCoordinates14(f,4)-0.5)*(473/44)),((FinalCoordinates14(f,5)-0.5)*(765/71)),'Color',[0.7 0.7 1],'LineWidth',2);
        finalcoordinates(1,1:2)=FinalCoordinates14(f(1),4:5);
        finalcoordinates(2,1:2)=FinalCoordinates14(f(end),4:5);
        plot(((finalcoordinates(:,1)-0.5)*(473/44)),((finalcoordinates(:,2)-0.5)*(765/71)),'Color',[0.7 0.7 1],'LineWidth',2);
    end
    ...
    if isempty(f)==0
        ...
        plot(((FinalCoordinates15(f,4)-0.5)*(473/44)),((FinalCoordinates15(f,5)-0.5)*(765/71)),'Color',[0.2 0.4 0.6],'LineWidth',2);
        finalcoordinates(1,1:2)=FinalCoordinates15(f(1),4:5);
        finalcoordinates(2,1:2)=FinalCoordinates15(f(end),4:5);
        plot(((finalcoordinates(:,1)-0.5)*(473/44)),((finalcoordinates(:,2)-0.5)*(765/71)),'Color',[0.2 0.4 0.6],'LineWidth',2);
    end
    ...
    if isempty(f)==0
        ...
        plot(((FinalCoordinates16(f,4)-0.5)*(473/44)),((FinalCoordinates16(f,5)-0.5)*(765/71)),'Color',[0.8 0.8 0.8],'LineWidth',2);
    ...
    if isempty(f)==0
        ...
        plot(((FinalCoordinates17(f,4)-0.5)*(473/44)),((FinalCoordinates17(f,5)-0.5)*(765/71)),'Color',[1 0.8 0.78],'LineWidth',2);
