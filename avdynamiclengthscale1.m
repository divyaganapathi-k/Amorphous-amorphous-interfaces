% clearvars
% % load('F:\dynamiclengthscale\W5\W5lengthoft.mat');
% R=load('D:\Raw Data\W5_0T_1-13500_trk(16,0,10)_DD(100).txt');
% R=load('D:\Raw Data\W5_0T_1-8000_trk(18,0,10)_DD(100).txt');
for zz=1:1:1
...
%         z1=41; z2=12;
    ...
    filename=strcat('D:\Final Data\1ta-data analysis\W5\W5-final-1ta-',num2str(z1),'-',num2str(z2),'.mat');
%     filename=strcat('D:\Final Data\1ta-data analysis\W5\W5-',num2str(zz),'.mat');
%     filename=('D:\Final Data\W5\W5-7t-final7.mat');
    load(filename);
...
%             lengthoft=eval(name);
        ...
        filename=strcat('D:\Newdataanalysis\avdynamiclengthscale\W5\W5dynamiclen',num2str(iii),'-',num2str(m1),'-',num2str(m2),'-2.mat');
