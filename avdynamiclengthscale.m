...
% load('E:\Shreyas-Dataanalysis\Analysis\Data-11\coordinates-85-49.mat');
m1=60;
m2=30;
...
%         lengthoft=eval(name);
    ...
    filename=strcat('D:\Newdataanalysis\W5dynamiclen',num2str(iii),'-',num2str(m1),'-',num2str(m2),'-2.mat');
%     filename=strcat('E:\Shreyas-Dataanalysis\Analysis\Data-7\D7dynamiclen',num2str(iii),'-',num2str(m1),'-',num2str(m2),'.mat');
