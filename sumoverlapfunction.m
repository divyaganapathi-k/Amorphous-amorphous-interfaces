...
% filename=strcat('D:\Final Data\1ta-data analysis\W8\W8-final-1ta-',num2str(m1),'-',num2str(m2),'.mat');
% load(filename);
filename=strcat('D:\Final Data\1ta-data analysis\W8\W8','-2.mat');
load(filename);
...
for i=1:1:20
    ...
    filename=strcat('D:\Newdataanalysis\sumoverlapfunction\W8\W8-',num2str(m1),'-',num2str(m2),'-',num2str(i),'-3.mat');
