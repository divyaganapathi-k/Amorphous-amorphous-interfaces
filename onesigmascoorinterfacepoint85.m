...
%     filename=strcat('D:\Final Data\W4\W4final-shiftedinterface7',num2str(ii),'.mat');
    filename=strcat('D:\Newdataanalysis\1boxes\W4\W4unpinned-shiftedinterfacetasigmas1',num2str(ii),'.mat');
    load(filename);
%     clearvars -except AA iii ii N2 addon1 addon2
%     filename=(strcat('D:\Newdataanalysis\1boxes\W4\W4unpinned-shiftedinterfacetasigmas1',num2str(ii),'.mat'));
%     filename=strcat('D:\Newdataanalysis\1boxes\W4\W4unpinned-shiftedinterfacetasigmas',num2str(iii),num2str(ii),'.mat');
%     filename=strcat('D:\Newdataanalysis\1boxes\W4\W4unpinned-shiftedinterfacetasigmas',num2str(iii),num2str(ii),'skip50.mat');    
%     load(filename);
    if ii==1
     addon1=((0)*sigmas);
     addon2=((0)*sigmas);
...
%         B=N2(:,:,i);
        ...
        y1=m2*(boxsiz)*(sigmas)+(addon2);    
        E=[];   
        E(:,1)=D(:,1)*(boxsiz)*(sigmas)+(addon1);
        E(:,2)=D(:,2)*(boxsiz)*(sigmas)+(addon2);
        E(:,3)=D(:,3);
